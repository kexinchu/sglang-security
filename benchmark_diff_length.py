...
"""
Usage:
python3 benchmark_diff_length.py --model_name doubao-1-5-pro-32k-250115

python3 benchmark_diff_length.py --model_name deepseek-r1-250528
"""
import os
import re
import string
...
# ---------- 每个子进程的工作 ----------
def worker(client, model_name, texts):
...
def main():
    ...
    for length in [512, 1024, 2048, 4096, 8192, 16384, 32758, 65536]:
        ...
        worker(client, args.model_name, texts)
