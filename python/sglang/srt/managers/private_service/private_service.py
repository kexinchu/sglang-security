...
class PrivateJudgeService:
    def __init__(self,
        ...
        # 初始化隐私检测器
        self.privacy_detector = PrivacyDetector("/root/code/sglang-security/python/sglang/srt/managers/private_service/privacy_patterns_config.json")
    ...
    def _process_result_tasks(self):
        ...
        while self.running:
            ...
            while len(self.result_queue) > 0:
                ...
                # self.send_to_client.send_json(task)
        ...
        while self.running:
            try:
                ...
                if not self.pii_bert_available:
                    ...
                    self.third_level_task_queue.append(task)
                    continue
    ...
    def _process_third_level_tasks(self):
        ...
        while self.running:
            try:
                task = self.third_level_task_queue.pop(0)
    ...
    def _process_third_level_tasks_(self):
